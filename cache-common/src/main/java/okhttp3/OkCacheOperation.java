 ...
 */
public final class OkCacheOperation implements Closeable, Flushable {
    ...
    public OkCacheOperation(File directory, long maxSize) {
        this(directory, maxSize, FileSystem.SYSTEM);
    }

    OkCacheOperation(File directory, long maxSize, FileSystem fileSystem) {
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        CacheRequestImpl(final DiskLruCache.Editor editor) {
            ...
            this.body = new ForwardingSink(cacheOut) {
                @Override
                public void close() throws IOException {
                    synchronized (OkCacheOperation.this) {
                        if (done) {
                            return;
                        }
                        done = true;
